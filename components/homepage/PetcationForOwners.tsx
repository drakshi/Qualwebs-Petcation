...
export default function PetcationForOwners() {
  return (
    <div className="booking-sitter">
      <div className="padding">
        <div className="container">
          <div className="row">
            <div className="col-12 col-md-12 col-sm-8 col-lg-8 col-xl-8 mx-auto">
              <div className="text-center main-title">
                <h2 className="font-semibold">
                  {strings.petcitationforPetOwners}
                </h2>
                <p className="mb-0">{strings.petcitationforPetOwners}</p>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-12 col-md-6 col-lg-6 col-xl-5 offset-xl-1">
