...
const api = new API();
export default function DropInVisitsPreview() {
    ...
    return (
      <div className="col-12 col-md-8 col-lg-8 col-xl-8 column1">
        ...
        <div className="bg-white main-background">
          ...
          <div className="row">
            {data.dropin_visit_service_fee.service_pets.map((v) => (
          ...
          <div className="extra-charge">
            ...
            <div className="preview-details">
              <h6 className="mb-0 font-medium">
                Range{" "}
                <span>
                  {data.dropin_visit_service_fee.holiday_extra_charges}%
                </span>
              </h6>
            </div>
          </div>
            ...
            <div className="booking-for">
              <div className="row">
                <div className="col-12 col-md-12 col-lg-12 col-xl-12">
                  {data.dropin_visit_service_fee.cancellation_policy == 1 ? (
                  ...
                  ) : data.dropin_visit_service_fee.cancellation_policy == 2 ? (
                    <div className="row  service-charges">
                      <div className="custom-check ml-3">
          ...
          <div className="bg-white main-background">
            <div className="service-title mb-2">
              ...
              <div className="main-padding pb-2">
                ...
                <h6 className="mb-0 font-medium">
                  {data.dropin_visit_service_preferences.visit_per_day +
                    " time"}
                </h6>
              </div>
              <hr />
              <div className="main-padding pb-2">
                ...
                <h6 className="mb-0 font-medium">
                  {data.dropin_visit_service_preferences.early_visit_provided ==
                  1
                    ? "Before 8 am"
                    : "after 6 pm"}
                </h6>
              ...
              <div className="main-padding pb-2">
                ...
                <h6 className="font-medium">
                  {`${data.dropin_visit_service_preferences.client_place_distance} km`}
                </h6>
              </div>
              <hr />
              <div className="main-padding pb-2">
                ...
                <h6 className="font-medium">
                  {data.dropin_visit_service_preferences
                    .has_transportation_fee == 1
                    ? "Yes"
                    : "No"}
                </h6>
                {data.dropin_visit_service_preferences.has_transportation_fee ==
                1 ? (
                  <div className="d-flex pet-pickup-details">
                    <div className="mr-5 font-14">
                      <p className="font-15 mb-2 mr-5"> transportation fee</p>
                      <h6 className="mb-0 font-14 font-medium">{`￥ ${data.dropin_visit_service_preferences.transportation_fee}`}</h6>
                    </div>
                  </div>
                ) : null}
              </div>
          ...
          <div className="bg-white main-background">
            <div className="service-title mb-2">
              ...
              <div className="main-padding pb-2">
                ...
                {data.dropin_visit_service_discount.first_booking_offered ==
                1 ? (
...
DropInVisitsPreview.getLayout = function (page) {
