...
const api = new API();
export default function PetDayCarePreview() {
    ...
    return (
      <div className="col-12 col-md-8 col-lg-8 col-xl-8 column1">
        ...
        <div className="bg-white main-background">
          ...
          <div className="row">
            {data.day_care_service_fee.service_pets.map((v) => (
          ...
          <div className="extra-charge">
            ...
            <div className="preview-details">
              <h6 className="mb-0 font-medium">
                Range{" "}
                <span>{data.day_care_service_fee.holiday_extra_charges}%</span>
              </h6>
            </div>
          </div>
          <hr />
            ...
            <div className="booking-for">
              <div className="row">
                <div className="col-12 col-md-12 col-lg-12 col-xl-12">
                  {data.day_care_service_fee.cancellation_policy == 1 ? (
                  ...
                  ) : data.day_care_service_fee.cancellation_policy == 2 ? (
                    <div className="row  service-charges">
                      <div className="custom-check ml-3">
          ...
          <div className="service-title mb-2">
              ...
              <h6 className="mb-0 font-medium">
                {
                  D_FLEXIBILITY.find(
                    (value) =>
                      data.day_care_service_preferences.flexibility_id ==
                      value.value
                  ).label
                }
              </h6>
              ...
              <h6 className="mb-0 font-medium">
                {
                  D_FREQUENT_BREAKS.find(
                    (value) =>
                      data.day_care_service_preferences.frequently_break_id ==
                      value.value
                  ).label
                }
              </h6>
            ...
            <div className="main-padding pb-2">
              ...
              <h6 className="font-medium">
                {data.day_care_service_preferences.pickup_from_client_home == 1
                  ? "Yes"
                  : "No"}
              </h6>
              <div className="d-flex pet-pickup-details">
                <div className="mr-5 font-14">
                  ...
                  <h6 className="mb-0 font-14 font-medium">
                    {
                      D_TRANSPORTATION.find(
                        (v) =>
                          v.value ==
                          data.day_care_service_preferences.transportation_id
                      ).label
                    }
                  </h6>
                </div>
                <div>
                  ...
                  <h6 className="mb-0 font-14 font-medium">{`${
                    D_DISTANCE.find(
                      (v) =>
                        v.value ==
                        data.day_care_service_preferences.travel_distance
                    ).label
                  }`}</h6>
                </div>
              </div>
            ...
            <div className="main-padding pb-2">
              ...
              <h6 className="font-medium">
                {data.day_care_service_preferences.has_transportation_fee == 1
                  ? "Yes"
                  : "No"}
              </h6>
              {data.day_care_service_preferences.has_transportation_fee == 1 ? (
                <div className="d-flex pet-pickup-details">
                  <div className="mr-5 font-14">
                    ...
                    <h6 className="mb-0 font-14 font-medium">{`￥${data.day_care_service_preferences.transportation_fee}`}</h6>
                  </div>
                </div>
              ) : null}
            </div>
        ...
        <div className="bg-white main-background">
          <div className="service-title mb-2">
            ...
            <div className="main-padding pb-2">
              ...
              {data.day_care_service_discount.first_booking_offered == 1 ? (
...
PetDayCarePreview.getLayout = function (page) {
